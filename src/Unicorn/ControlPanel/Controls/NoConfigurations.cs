...
namespace Unicorn.ControlPanel.Controls
{
	...
	internal class NoConfigurations : IControlPanelControl
	{
		public void Render(HtmlTextWriter writer)
		{
			...
			writer.Write("<p>To help with defining your first configuration, see the <code>Unicorn.Configs.Default.example</code> that should be in App_Config\\Modules\\Unicorn for an example you can use as a starting point.</p>");
